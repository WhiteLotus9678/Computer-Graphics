...
var _three = __webpack_require__(/*! three */ 22);

var THREE = _interopRequireWildcard(_three);

var _AnimatableMesh = __webpack_require__(/*! ../helpers/AnimatableMesh */ 134);
...
MeshFactory.wrapGeometryWithMesh = function (geometry, name) {
  return new _AnimatableMesh2.default(geometry, MeshFactory.widget._solidMaterial, name);
};
...
var	fixUrls = __webpack_require__(/*! ./urls */ 361);
...
var _Transform = __webpack_require__(/*! ./Transform */ 135);

var _Transform2 = _interopRequireDefault(_Transform);

var _KeyframeTransform = __webpack_require__(/*! ./KeyframeTransform */ 366);

var _KeyframeTransform2 = _interopRequireDefault(_KeyframeTransform);

var _config = __webpack_require__(/*! ../config.js */ 95);
...
var AnimatableMesh = function (_THREE$Mesh) {
  ...
  _createClass(AnimatableMesh, [{
    ...
    value: function interpolateFrames(requestedFrameNum, prevFrameNum, nextFrameNum, prevTrans, nextTrans) {
      ...
      var alpha = (requestedFrameNum - prevFrameNum) / (nextFrameNum - prevFrameNum); // (C - A) / (B - A)
...
__webpack_require__(/*! jqtree/jqtree.css */ 367);

__webpack_require__(/*! jqtree/tree.jquery */ 369);

__webpack_require__(/*! bootstrap-slider/dist/css/bootstrap-slider.css */ 370);

__webpack_require__(/*! bootstrap-slider/dist/bootstrap-slider */ 137);

var _config = __webpack_require__(/*! ./config.js */ 95);

var _config2 = _interopRequireDefault(_config);

var _AnimationFactory = __webpack_require__(/*! ./objects/AnimationFactory */ 372);
...
var Interface = {
  initialize: function initialize() {
    ...
    Interface.frameSlider = (0, _jquery2.default)('#frameSlider').slider({
      min: 0, max: _config2.default.MAX_FRAMES, value: 0, ticks: ticksArray
    });
...
function updateSelectedMesh(meshObj) {
  ...
  if (meshObj) {
    ...
    (0, _jquery2.default)('#xTranslate').val(sanitizeValue(meshObj.transform._position.x, 0));
    (0, _jquery2.default)('#yTranslate').val(sanitizeValue(meshObj.transform._position.y, 0));
    (0, _jquery2.default)('#zTranslate').val(sanitizeValue(meshObj.transform._position.z, 0));

    (0, _jquery2.default)('#xScale').val(sanitizeValue(meshObj.transform._scale.x, 1));
    (0, _jquery2.default)('#yScale').val(sanitizeValue(meshObj.transform._scale.y, 1));
    (0, _jquery2.default)('#zScale').val(sanitizeValue(meshObj.transform._scale.z, 1));

    (0, _jquery2.default)('#xAngle').val(sanitizeValue(meshObj.transform._rotation.x / Math.PI * 180, 0));
    (0, _jquery2.default)('#yAngle').val(sanitizeValue(meshObj.transform._rotation.y / Math.PI * 180, 0));
    (0, _jquery2.default)('#zAngle').val(sanitizeValue(meshObj.transform._rotation.z / Math.PI * 180, 0));

    (0, _jquery2.default)('#xPivot').val(sanitizeValue(meshObj.transform._pivotPoint.x, 0));
    (0, _jquery2.default)('#yPivot').val(sanitizeValue(meshObj.transform._pivotPoint.y, 0));
    (0, _jquery2.default)('#zPivot').val(sanitizeValue(meshObj.transform._pivotPoint.z, 0));
...
function updateShapeTransformation(e) {
  ...
  if (meshNode) {
    ...
    meshObj.transform.setPosition(sanitizeValue(parseFloat((0, _jquery2.default)('#xTranslate').val()), meshObj.transform.position.x), sanitizeValue(parseFloat((0, _jquery2.default)('#yTranslate').val()), meshObj.transform.position.y), sanitizeValue(parseFloat((0, _jquery2.default)('#zTranslate').val()), meshObj.transform.position.z));

    meshObj.transform.setScale(sanitizeValue(parseFloat((0, _jquery2.default)('#xScale').val()), meshObj.transform.scale.x), sanitizeValue(parseFloat((0, _jquery2.default)('#yScale').val()), meshObj.transform.scale.y), sanitizeValue(parseFloat((0, _jquery2.default)('#zScale').val()), meshObj.transform.scale.z));

    meshObj.transform.setRotation(sanitizeValue(parseFloat((0, _jquery2.default)('#xAngle').val()) / 180 * Math.PI, meshObj.transform.rotation.x), sanitizeValue(parseFloat((0, _jquery2.default)('#yAngle').val()) / 180 * Math.PI, meshObj.transform.rotation.y), sanitizeValue(parseFloat((0, _jquery2.default)('#zAngle').val()) / 180 * Math.PI, meshObj.transform.rotation.z));

    meshObj.transform.setPivot(sanitizeValue(parseFloat((0, _jquery2.default)('#xPivot').val()), meshObj.transform.pivot.x), sanitizeValue(parseFloat((0, _jquery2.default)('#yPivot').val()), meshObj.transform.pivot.y), sanitizeValue(parseFloat((0, _jquery2.default)('#zPivot').val()), meshObj.transform.pivot.z));
...
module.exports = __webpack_require__(/*! D:\Student Data\Desktop\CS-343 Mathematical Foundations of Computer Graphics\Project 4\gfx-3d-base-master\src\main.js */342);
...
__webpack_require__(/*! bootstrap/dist/css/bootstrap.min.css */ 355);

var _jquery = __webpack_require__(/*! jquery */ 5);

var _jquery2 = _interopRequireDefault(_jquery);

var _Detector = __webpack_require__(/*! three/examples/js/Detector */ 362);

var _Detector2 = _interopRequireDefault(_Detector);

var _MeshWidget = __webpack_require__(/*! ./helpers/MeshWidget */ 363);
...
// load the styles
var content = __webpack_require__(/*! !../../../css-loader!./bootstrap.min.css */ 356);
...
var update = __webpack_require__(/*! ../../../style-loader/lib/addStyles.js */ 94)(content, options);
...
__webpack_require__(/*! three/examples/js/controls/OrbitControls */ 364);

__webpack_require__(/*! three/examples/js/controls/TrackballControls */ 365);

var _AnimatableMesh = __webpack_require__(/*! ./AnimatableMesh */ 134);
...
var _config = __webpack_require__(/*! ../config */ 95);
...
var MeshWidget = function () {
  ...
  _createClass(MeshWidget, [{
    ...
    key: 'requestMeshUpdate',
    value: function requestMeshUpdate(frameNumber) {
      this._updateToFrame = Math.max(0, Math.min(_config2.default.MAX_FRAMES, frameNumber || 0));
      this._updateRequested = true;
    }
  }, {
    key: 'requestResize',
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! three */ 22)))
...
var _Transform2 = __webpack_require__(/*! ./Transform */ 135);
...
var KeyframeTransform = function (_Transform) {
  ...
  _createClass(KeyframeTransform, [{
    ...
    value: function lerp(Btrans, alpha) {
      ...
      // Position
      interp.setPosition(this._position.x + alpha * (Btrans._position.x - this._position.x), this._position.y + alpha * (Btrans._position.y - this._position.y), this._position.z + alpha * (Btrans._position.z - this._position.z));

      // Rotation
      interp.setRotation(this._rotation.x + alpha * (Btrans._rotation.x - this._rotation.x), this._rotation.y + alpha * (Btrans._rotation.y - this._rotation.y), this._rotation.z + alpha * (Btrans._rotation.z - this._rotation.z));

      // Scale
      interp.setScale(this._scale.x + alpha * (Btrans._scale.x - this._scale.x), this._scale.y + alpha * (Btrans._scale.y - this._scale.y), this._scale.z + alpha * (Btrans._scale.z - this._scale.z));

      // Pivot Point setPivot
      interp.setPivot(this._pivotPoint.x + alpha * (Btrans._pivotPoint.x - this._pivotPoint.x), this._pivotPoint.y + alpha * (Btrans._pivotPoint.y - this._pivotPoint.y), this._pivotPoint.z + alpha * (Btrans._pivotPoint.z - this._pivotPoint.z));
...
// load the styles
var content = __webpack_require__(/*! !../css-loader!./jqtree.css */ 368);
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
// load the styles
var content = __webpack_require__(/*! !../../../css-loader!./bootstrap-slider.css */ 371);
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
var _HumanoidFactory = __webpack_require__(/*! ./HumanoidFactory */ 373);
...
var AnimationFactory = function () {
  ...
  _createClass(AnimationFactory, [{
    ...
    value: function extractNamedNodes(humanoid, name) {
    ...
    value: function generateWalk() {
      ...
      // arms[2] = Left Arm
      // arms[3] = L Arm
      var arms = this.extractNamedNodes(humanoid, 'Arm');
      ...
      // legs[2] = Right Leg
      // legs[3] = R Leg
      var legs = this.extractNamedNodes(humanoid, 'Leg');
...
var _CubeFactory = __webpack_require__(/*! ./CubeFactory */ 374);

var _CubeFactory2 = _interopRequireDefault(_CubeFactory);

var _CylinderFactory = __webpack_require__(/*! ./CylinderFactory */ 375);

var _CylinderFactory2 = _interopRequireDefault(_CylinderFactory);

var _SphereFactory = __webpack_require__(/*! ./SphereFactory */ 376);
