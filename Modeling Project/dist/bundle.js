...
if (__webpack_require__(/*! ./_descriptors */ 7)) {
  ...
  var toInteger = __webpack_require__(/*! ./_to-integer */ 26);
  var toLength = __webpack_require__(/*! ./_to-length */ 9);
  var toIndex = __webpack_require__(/*! ./_to-index */ 124);
...
var store = shared.store || (shared.store = new (__webpack_require__(/*! ./es6.weak-map */ 122))());
...
var _three = __webpack_require__(/*! three */ 12);

var THREE = _interopRequireWildcard(_three);

var _Transform = __webpack_require__(/*! ../helpers/Transform */ 368);
...
var MeshFactory = function () {
  ...
  _createClass(MeshFactory, [{
    ...
    value: function generateMesh() {
      ...
      mesh.transform = new _Transform2.default(mesh);
...
MeshFactory.wrapGeometryWithMesh = function (geometry, name) {
  var mesh = new THREE.Mesh(geometry, MeshFactory.widget._solidMaterial);
 ...
 * @static
 **/
MeshFactory.generateEmptyNode = function (name) {
 ...
 * @static
 **/
MeshFactory.isolateScale = function (mesh) {
...
var core = __webpack_require__(/*! ./_core */ 23);
var LIBRARY = __webpack_require__(/*! ./_library */ 36);
var wksExt = __webpack_require__(/*! ./_wks-ext */ 99);
...
var _MeshFactory2 = __webpack_require__(/*! ./MeshFactory */ 31);
...
var CylinderFactory = function (_MeshFactory) {
  ...
  _createClass(CylinderFactory, [{
    ...
    value: function makeObjectGeometry() {
      ...
      for (var _i = 1; _i <= this._slices; _i++) {
        if (_i === this._slices) {
          cylGeom.faces.push(new THREE.Face3(1, _i, 0, normals[0]));
        } else {
          cylGeom.faces.push(new THREE.Face3(_i + 1, _i, 0, normals[0]));
        }
      }

      // topCircle checks the length of the vertices on the bottom circle
      // Later used to draw faces for the side
      var topCircle = cylGeom.vertices.length;
      ...
      for (var _i2 = this._slices; _i2 > 0; _i2--) {
        theta = _i2 / this._slices * Math.PI * 2;
        cylGeom.vertices.push(new THREE.Vector3(Math.cos(theta), 1, Math.sin(theta)));
        normals.push(new THREE.Vector3(Math.cos(theta), 0, Math.sin(theta)));
      }

      // Push the faces for the top circle
      for (var _i3 = 1; _i3 <= this._slices; _i3++) {
        if (_i3 === this._slices) {
          cylGeom.faces.push(new THREE.Face3(this._slices + 2, this._slices + 1, _i3 + this._slices + 1, normals[this._slices + 1]));
        } else {
          cylGeom.faces.push(new THREE.Face3(_i3 + this._slices + 2, this._slices + 1, _i3 + this._slices + 1, normals[this._slices + 1]));
        }
      }
      ...
      // A---B
      //
      for (var _i4 = 1; _i4 <= this._slices; _i4++) {
        var A = _i4;
        var B = A + 1;
        var C = topCircle + _i4;
        var D = C + 1;

        // Alter vertices B and D to draw the last face of the cylinder
        if (_i4 === this._slices) {
          B = 1;
          D = topCircle + 1;
        }
...
var SphereFactory = function (_MeshFactory) {
  ...
  _createClass(SphereFactory, [{
    ...
    value: function makeObjectGeometry() {
      ...
      var theta = 0; // Angle used for each slice - [0..2*PI) - Longitude
      var phi = 0; // Angle for each stack - [0...PI] - Latitude
      var deltaTheta = 2 * Math.PI / this._slices; // Radians per longitude line
      var deltaPhi = Math.PI / this._stacks; // Radians per latitude line
      var globalTracker = 0; // Tracks the global amount of vertices made for the whole sphere
      var localTracker = 0; // Tracks the current amount of vertices made for each stack
      var CCW = false; // Controls clockwise/counter-clockwise winding
      ...
      for (var i = 0; i < this._slices; i++) {
        ...
        for (var j = 0; j <= this._stacks * 2 + 1; j++) {
          // Push two vertices per level to create a tri-face at each stack
          sphereGeom.vertices.push(new THREE.Vector3(Math.sin(theta) * Math.sin(phi), Math.cos(phi), Math.cos(theta) * Math.sin(phi)));

          // Push the normal for the vertex
          normals.push(new THREE.Vector3(Math.sin(theta) * Math.sin(phi), Math.cos(phi), Math.cos(theta) * Math.sin(phi)));

          sphereGeom.vertices.push(new THREE.Vector3(Math.sin(theta + deltaTheta) * Math.sin(phi), Math.cos(phi), Math.cos(theta + deltaTheta) * Math.sin(phi)));

          normals.push(new THREE.Vector3(Math.sin(theta + deltaTheta) * Math.sin(phi), Math.cos(phi), Math.cos(theta + deltaTheta) * Math.sin(phi)));
...
var strong = __webpack_require__(/*! ./_collection-strong */ 120);
...
var weak = __webpack_require__(/*! ./_collection-weak */ 123);
var isObject = __webpack_require__(/*! ./_is-object */ 4);
var fails = __webpack_require__(/*! ./_fails */ 3);
var validate = __webpack_require__(/*! ./_validate-collection */ 48);
...
var	fixUrls = __webpack_require__(/*! ./urls */ 360);
...
__webpack_require__(/*! jqtree/jqtree.css */ 365);

__webpack_require__(/*! jqtree/tree.jquery */ 367);

var _CubeFactory = __webpack_require__(/*! ./objects/CubeFactory */ 93);

var _CubeFactory2 = _interopRequireDefault(_CubeFactory);

var _CylinderFactory = __webpack_require__(/*! ./objects/CylinderFactory */ 94);

var _CylinderFactory2 = _interopRequireDefault(_CylinderFactory);

var _SphereFactory = __webpack_require__(/*! ./objects/SphereFactory */ 95);

var _SphereFactory2 = _interopRequireDefault(_SphereFactory);

var _ClothFactory = __webpack_require__(/*! ./objects/ClothFactory */ 388);

var _ClothFactory2 = _interopRequireDefault(_ClothFactory);

var _SculptureFactory = __webpack_require__(/*! ./objects/SculptureFactory */ 369);

var _SculptureFactory2 = _interopRequireDefault(_SculptureFactory);

var _HumanoidFactory = __webpack_require__(/*! ./objects/HumanoidFactory */ 370);

var _HumanoidFactory2 = _interopRequireDefault(_HumanoidFactory);

var _ExtraCredit1Factory = __webpack_require__(/*! ./objects/ExtraCredit1Factory */ 371);

var _ExtraCredit1Factory2 = _interopRequireDefault(_ExtraCredit1Factory);

var _ExtraCredit2Factory = __webpack_require__(/*! ./objects/ExtraCredit2Factory */ 372);

var _ExtraCredit2Factory2 = _interopRequireDefault(_ExtraCredit2Factory);

var _ObjLoader = __webpack_require__(/*! ./objects/ObjLoader */ 373);
...
var Interface = {
  initialize: function initialize() {
    ...
    (0, _jquery2.default)(document).on('change', ':file', function () {
    ...
    (0, _jquery2.default)(':File').on('fileselect', function (event, numFiles, label) {
      // Update the text field to show what was selected
      var input = (0, _jquery2.default)(this).parents('.input-group').find(':text');
    ...
    (0, _jquery2.default)('#createCylinder').click(function () {
      Interface.cylinderFactory.slices = parseInt((0, _jquery2.default)('#cylinderSlices').val());
      var mesh = Interface.cylinderFactory.generateMesh();
      Interface.widget.requestRebuild(mesh);
    });

    (0, _jquery2.default)('#createSphere').click(function () {
      Interface.sphereFactory.slices = parseInt((0, _jquery2.default)('#sphereSlices').val());
      Interface.sphereFactory.stacks = parseInt((0, _jquery2.default)('#sphereStacks').val());
      var mesh = Interface.sphereFactory.generateMesh();
      Interface.widget.requestRebuild(mesh);
    });

    (0, _jquery2.default)('#createEC1').click(function () {
      Interface.extraCredit1Factory.param1 = parseInt((0, _jquery2.default)('#ec1Param1').val());
      Interface.extraCredit1Factory.param2 = parseInt((0, _jquery2.default)('#ec1Param2').val());
      Interface.extraCredit1Factory.param3 = parseInt((0, _jquery2.default)('#ec1Param3').val());
      var mesh = Interface.extraCredit1Factory.generateMesh();
      Interface.widget.requestRebuild(mesh);
    });

    (0, _jquery2.default)('#createEC2').click(function () {
      Interface.extraCredit2Factory.param1 = parseInt((0, _jquery2.default)('#ec1Param1').val());
      Interface.extraCredit2Factory.param2 = parseInt((0, _jquery2.default)('#ec1Param2').val());
      Interface.extraCredit2Factory.param3 = parseInt((0, _jquery2.default)('#ec1Param3').val());
      var mesh = Interface.extraCredit2Factory.generateMesh();
      Interface.widget.requestRebuild(mesh);
    });

    (0, _jquery2.default)('#objLoadButton').click(function () {
      _ObjLoader2.default.loadAndAddOBJ((0, _jquery2.default)('#objFile')[0].files[0]);
    });
    ...
    (0, _jquery2.default)('#smoothNormals').click(function () {
      Interface.widget.smoothNormals();
    });

    (0, _jquery2.default)('#faceNormals').click(function () {
      Interface.widget.computePerFaceNormals();
    });

    // Load a shape of some type
    (0, _jquery2.default)('#shapeLoad').change(handleLoadShape);

    // Respond to render mode changes
    (0, _jquery2.default)('#renderingMode').change(handleRenderModeChange);
...
Interface.cubeFactory = new _CubeFactory2.default();
Interface.cylinderFactory = new _CylinderFactory2.default();
Interface.sphereFactory = new _SphereFactory2.default();
Interface.clothFactory = new _ClothFactory2.default();
Interface.sculptureFactory = new _SculptureFactory2.default();
Interface.humanoidFactory = new _HumanoidFactory2.default();
Interface.extraCredit1Factory = new _ExtraCredit1Factory2.default();
Interface.extraCredit2Factory = new _ExtraCredit2Factory2.default();
...
_ObjLoader2.default.onGeometryReady = function (mesh) {
  var fileLabel = (0, _jquery2.default)('#objFile').parents('.input-group').find(':text').val();
  mesh.name = fileLabel;
  Interface.widget.requestRebuild(mesh);
};
...
function handleLoadShape() {
  ...
  var typeSelector = (0, _jquery2.default)('#shapeLoad')[0];
  switch (typeSelector.selectedIndex) {
    // Basic geometry
    case 2:
      var mesh = Interface.cubeFactory.generateMesh();
      Interface.widget.requestRebuild(mesh);
      break;

    case 3:
      (0, _jquery2.default)('#createCylinderModal').modal();break;
    case 4:
      (0, _jquery2.default)('#createSphereModal').modal();break;
    ...
    case 9:
      (0, _jquery2.default)('#createEC1Modal').modal();break;
    case 10:
      (0, _jquery2.default)('#createEC2Modal').modal();break;

    // Loading of arbitrary geometry files
    case 12:
      (0, _jquery2.default)('#objLoadModal').modal();break;
  ...
  (0, _jquery2.default)('#renderingMode')[0].selectedIndex = 0;
}

// Respond when the user changes the current rendering mode
function handleRenderModeChange() {
  var modeSelector = (0, _jquery2.default)('#renderingMode')[0];
...
module.exports = __webpack_require__(/*! D:\Student Data\Desktop\CS-343 Mathematical Foundations of Computer Graphics\Project 3\gfx-3d-base-Project3\src\main.js */341);
...
var gOPNExt = __webpack_require__(/*! ./_object-gopn-ext */ 102);
var $GOPD = __webpack_require__(/*! ./_object-gopd */ 18);
var $DP = __webpack_require__(/*! ./_object-dp */ 8);
...
$export($export.S + $export.F * !__webpack_require__(/*! ./_descriptors */ 7), 'Object', { defineProperties: __webpack_require__(/*! ./_object-dps */ 101) });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(/*! ./_hide */ 14)(proto, TO_PRIMITIVE, __webpack_require__(/*! ./_date-to-primitive */ 223));
...
var perform = __webpack_require__(/*! ./_perform */ 117);
var promiseResolve = __webpack_require__(/*! ./_promise-resolve */ 118);
var PROMISE = 'Promise';
var TypeError = global.TypeError;
var process = global.process;
var $Promise = global[PROMISE];
...
$export($export.S, 'Reflect', { ownKeys: __webpack_require__(/*! ./_own-keys */ 125) });
...
var $export = __webpack_require__(/*! ./_export */ 0);
var flattenIntoArray = __webpack_require__(/*! ./_flatten-into-array */ 126);
var toObject = __webpack_require__(/*! ./_to-object */ 10);
var toLength = __webpack_require__(/*! ./_to-length */ 9);
var aFunction = __webpack_require__(/*! ./_a-function */ 11);
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(/*! ./_export */ 0);
var $pad = __webpack_require__(/*! ./_string-pad */ 127);
...
var $export = __webpack_require__(/*! ./_export */ 0);
var ownKeys = __webpack_require__(/*! ./_own-keys */ 125);
var toIObject = __webpack_require__(/*! ./_to-iobject */ 17);
var gOPD = __webpack_require__(/*! ./_object-gopd */ 18);
var createProperty = __webpack_require__(/*! ./_create-property */ 84);
...
var $export = __webpack_require__(/*! ./_export */ 0);
var $values = __webpack_require__(/*! ./_object-to-array */ 128)(false);
...
// https://github.com/tc39/proposal-object-values-entries
var $export = __webpack_require__(/*! ./_export */ 0);
var $entries = __webpack_require__(/*! ./_object-to-array */ 128)(true);
...
$export($export.P + $export.R, 'Set', { toJSON: __webpack_require__(/*! ./_collection-to-json */ 129)('Set') });
...
// https://rwaldron.github.io/proposal-math-extensions/
var $export = __webpack_require__(/*! ./_export */ 0);
var scale = __webpack_require__(/*! ./_math-scale */ 131);
...
$export($export.S, 'Math', { scale: __webpack_require__(/*! ./_math-scale */ 131) });
...
__webpack_require__(/*! bootstrap */ 132);
...
var _Detector = __webpack_require__(/*! three/examples/js/Detector */ 361);

var _Detector2 = _interopRequireDefault(_Detector);

var _MeshWidget = __webpack_require__(/*! ./helpers/MeshWidget */ 362);

var _MeshWidget2 = _interopRequireDefault(_MeshWidget);

var _interface = __webpack_require__(/*! ./interface */ 136);

var _interface2 = _interopRequireDefault(_interface);

var _MeshFactory = __webpack_require__(/*! ./objects/MeshFactory */ 31);
...
(0, _jquery2.default)(document).ready(function () {
  ...
  if (!_Detector2.default.webgl) {
    ...
    _Detector2.default.addGetWebGLMessage({ parent: (0, _jquery2.default)('#GLWidget')[0] });
    return;
  }
...
var update = __webpack_require__(/*! ../../../style-loader/lib/addStyles.js */ 135)(content, options);
...
__webpack_require__(/*! three/examples/js/controls/OrbitControls */ 363);

__webpack_require__(/*! three/examples/js/controls/TrackballControls */ 364);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! three */ 12)))
...
// load the styles
var content = __webpack_require__(/*! !../css-loader!./jqtree.css */ 366);
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
var Transform = function () {
  ...
  _createClass(Transform, [{
    ...
    value: function rebuildMatrix() {
      ...
      // Away From Pivot
      var F = new THREE.Matrix4().makeTranslation(-this._pivotPoint.x, -this._pivotPoint.y, -this._pivotPoint.z);
      ...
      // Back To Pivot
      var P = new THREE.Matrix4().makeTranslation(this._pivotPoint.x, this._pivotPoint.y, this._pivotPoint.z);
...
/* 369 */
/*!*****************************************!*\
  !*** ./src/objects/SculptureFactory.js ***!
  \*****************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
var _CubeFactory = __webpack_require__(/*! ./CubeFactory */ 93);

var _CubeFactory2 = _interopRequireDefault(_CubeFactory);

var _CylinderFactory = __webpack_require__(/*! ./CylinderFactory */ 94);

var _CylinderFactory2 = _interopRequireDefault(_CylinderFactory);

var _SphereFactory = __webpack_require__(/*! ./SphereFactory */ 95);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // Parent class
 ...
 **/
var SculptureFactory = function (_MeshFactory) {
  _inherits(SculptureFactory, _MeshFactory);

  /**
   * Create a new sculpture factory object.
   **/
  function SculptureFactory() {
    _classCallCheck(this, SculptureFactory);

    var _this = _possibleConstructorReturn(this, (SculptureFactory.__proto__ || Object.getPrototypeOf(SculptureFactory)).call(this));

    _this._name = 'Sculpture';
    return _this;
  }
  ...
  _createClass(SculptureFactory, [{
    key: 'generateMesh',
    value: function generateMesh() {
      // Empty root objects for the entire bell sculpture
      this.root = _MeshFactory3.default.generateEmptyNode('Sculpture'); // Global root for the entire structure
      this.floor = _MeshFactory3.default.generateEmptyNode('Floor');
      this.bell = _MeshFactory3.default.generateEmptyNode('Bell');
      this.poles = _MeshFactory3.default.generateEmptyNode('Poles');
      this.bench1 = _MeshFactory3.default.generateEmptyNode('Bench 1');
      this.bench2 = _MeshFactory3.default.generateEmptyNode('Bench 2');
      this.bench3 = _MeshFactory3.default.generateEmptyNode('Bench 3');
      this.bench4 = _MeshFactory3.default.generateEmptyNode('Bench 4');

      // Mesh factories for each 3D shape
      this.cubeMaker = new _CubeFactory2.default();
      this.cylMaker = new _CylinderFactory2.default();
      this.sphereMaker = new _SphereFactory2.default();
    ...
    */
    ...
    value: function buildBenches() {
      ...
      var bench1RightLeg = this.cubeMaker.generateMesh();
      ...
      var bench1LeftLeg = this.cubeMaker.generateMesh();
      ...
      var bench2Top = this.cubeMaker.generateMesh();
      ...
      var bench2RightLeg = this.cubeMaker.generateMesh();
      ...
      var bench2LeftLeg = this.cubeMaker.generateMesh();
      ...
      var bench3Top = this.cubeMaker.generateMesh();
      ...
      var bench3RightLeg = this.cubeMaker.generateMesh();
      ...
      var bench3LeftLeg = this.cubeMaker.generateMesh();
      ...
      var bench4Top = this.cubeMaker.generateMesh();
      ...
      var bench4RightLeg = this.cubeMaker.generateMesh();
      ...
      var bench4LeftLeg = this.cubeMaker.generateMesh();
    ...
    value: function buildPoles() {
      ...
      for (var i = 0; i < poles; i++) {
        ...
        for (var j = 0; j < spheres; j++) {
          ...
          var sphere = this.sphereMaker.generateMesh();

          // Name the sphere based on k
          sphere.name = 'Sphere ' + k;

          // Set the sphere along the pole
          sphere.transform.setPosition(Math.sin(theta) * Math.sin(phi) * radius, Math.cos(phi) * radius, Math.cos(theta) * Math.sin(phi) * radius);
  ...
  return SculptureFactory;
}(_MeshFactory3.default);

exports.default = SculptureFactory;
...
var HumanoidFactory = function (_MeshFactory) {
  ...
  _createClass(HumanoidFactory, [{
    ...
    value: function generateMesh() {
      ...
      this.root = _MeshFactory3.default.generateEmptyNode('Humanoid'); // Global root for the entire structure
      this.torso = _MeshFactory3.default.generateEmptyNode('Torso');
      this.shoulders = _MeshFactory3.default.generateEmptyNode('Shoulders');
      this.hips = _MeshFactory3.default.generateEmptyNode('Hips');
    ...
    */
    ...
    value: function buildShoulders() {
      ...
      this.neck = _MeshFactory3.default.generateEmptyNode('Neck');
      ...
      this.head = _MeshFactory3.default.generateEmptyNode('Head');
      ...
      this.leftArm = _MeshFactory3.default.generateEmptyNode('Left Arm');
      this.leftArm.transform.setPivot(-2.1, -5.5, 0.0);

      this.lArm = _MeshFactory3.default.generateEmptyNode('L Arm');
      ...
      this.lHand = _MeshFactory3.default.generateEmptyNode('L Hand');
      ...
      this.rightArm = _MeshFactory3.default.generateEmptyNode('Right Arm');
      this.rightArm.transform.setPivot(2.1, -5.5, 0.0);

      this.rArm = _MeshFactory3.default.generateEmptyNode('R Arm');
      ...
      this.rHand = _MeshFactory3.default.generateEmptyNode('R Hand');
    ...
    */
    ...
    value: function buildHips() {
      ...
      this.rightLeg = _MeshFactory3.default.generateEmptyNode('Right Leg');
      this.rightLeg.transform.setPivot(1.5, 0.0, 0.0);

      this.rLeg = _MeshFactory3.default.generateEmptyNode('R Leg');
      ...
      this.rFoot = _MeshFactory3.default.generateEmptyNode('R Foot');
      ...
      this.leftLeg = _MeshFactory3.default.generateEmptyNode('Left Leg');
      this.leftLeg.transform.setPivot(-1.5, 0.0, 0.0);

      this.lLeg = _MeshFactory3.default.generateEmptyNode('L Leg');
      ...
      this.lFoot = _MeshFactory3.default.generateEmptyNode('L Foot');
...
/* 371 */
/*!********************************************!*\
  !*** ./src/objects/ExtraCredit1Factory.js ***!
  \********************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
 ...
 **/
var ExtraCredit1Factory = function (_MeshFactory) {
  _inherits(ExtraCredit1Factory, _MeshFactory);
   ...
   **/
  function ExtraCredit1Factory(param1, param2, param3) {
    _classCallCheck(this, ExtraCredit1Factory);

    var _this = _possibleConstructorReturn(this, (ExtraCredit1Factory.__proto__ || Object.getPrototypeOf(ExtraCredit1Factory)).call(this));

    _this._name = 'Extra Credit 1';
    _this._param1 = param1 || 10;
    _this._param2 = param2 || 10;
    _this._param3 = param3 || 10;
    return _this;
  }
  ...
  _createClass(ExtraCredit1Factory, [{
    key: 'makeObjectGeometry',
  ...
  return ExtraCredit1Factory;
}(_MeshFactory3.default);

// Export the ExtraCredit1Factory class for use in other modules


exports.default = ExtraCredit1Factory;

/***/ }),
/* 372 */
/*!********************************************!*\
  !*** ./src/objects/ExtraCredit2Factory.js ***!
  \********************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
 ...
 * to match whatever you remove.
 **/
var ExtraCredit2Factory = function (_MeshFactory) {
  _inherits(ExtraCredit2Factory, _MeshFactory);
   ...
   * @param {param3} number Some third necessary subdivision parameter.
   **/
  function ExtraCredit2Factory(param1, param2, param3) {
    _classCallCheck(this, ExtraCredit2Factory);

    var _this = _possibleConstructorReturn(this, (ExtraCredit2Factory.__proto__ || Object.getPrototypeOf(ExtraCredit2Factory)).call(this));

    _this._name = 'Extra Credit 2';
    _this._param1 = param1 || 10;
    _this._param2 = param2 || 10;
    _this._param3 = param3 || 10;
    return _this;
  ...
  _createClass(ExtraCredit2Factory, [{
    key: 'makeObjectGeometry',
  ...
  return ExtraCredit2Factory;
}(_MeshFactory3.default);

// Export the ExtraCredit2Factory class for use in other modules


exports.default = ExtraCredit2Factory;

/***/ }),
/* 373 */
/*!**********************************!*\
  !*** ./src/objects/ObjLoader.js ***!
  \**********************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__(/*! three/examples/js/loaders/OBJLoader */ 374);

__webpack_require__(/*! ../helpers/localOBJLoader */ 375);

var _MeshFactory = __webpack_require__(/*! ./MeshFactory */ 31);
...
var ObjLoader = {
  ...
  loadAndAddOBJ: function loadAndAddOBJ(fileBlob) {
  ...
  parseOBJResults: function parseOBJResults(objHierarchy) {
  ...
  convertObjHierarchy: function convertObjHierarchy(objHierarchy, mergedBBox) {
    // Build an empty Object3D to hold the new hierarchy
    var meshHierarchy = new THREE.Object3D();

    // Process all the children
    objHierarchy.traverse(function (child) {
      if (child instanceof THREE.Mesh) {
        // Convert child to standard 'Geometry'
        var newChild = _MeshFactory2.default.wrapGeometryWithMesh(new THREE.Geometry().fromBufferGeometry(child.geometry));
  ...
  findPrincipleAxisLength: function findPrincipleAxisLength(bbox) {
    var lengths = [bbox.max.x - bbox.min.x, bbox.max.y - bbox.min.y, bbox.max.z - bbox.min.z];

    return Math.sqrt(lengths[0] * lengths[0] + lengths[1] * lengths[1] + lengths[2] * lengths[2]);
  },

  // Check if the 'onGeometryReady' function is set and call it if so.
  // NOTE: This is usally set in main.js or interface.js
  geometryReady: function geometryReady(geometry) {
 ...
 **/
var ClothFactory = function (_MeshFactory) {
  _inherits(ClothFactory, _MeshFactory);
  ...
  function ClothFactory() {
    _classCallCheck(this, ClothFactory);

    var _this = _possibleConstructorReturn(this, (ClothFactory.__proto__ || Object.getPrototypeOf(ClothFactory)).call(this));

    _this._count++;
    _this._name = 'Cloth ' + _this._count;
    return _this;
  }
